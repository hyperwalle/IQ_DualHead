...
#pragma region configure DUT to calibration and begin timer
		...
		//if ( ERR_OK!=err )
		//{
		//	LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_Run(GET_CAL_SETTING) return error.\n");
		//	//throw logMessage;
		//}
		//else
		//{
		...
		_ftime64_s (&start_time);  //IQlite merge;Tracy Yu; 2012-03-31
#pragma endregion	
...
#pragma region measurement till done
		...
		while(1)
		{
			...
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(CAL_DONE) return OK.\n");
			}
            
            if(iCalDone)
            {
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] Calibration Done.\n");
                break;
            }
            else
            {
			...
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(CAL_ABORT) return OK.\n");
			}
			...
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(FREQ_MHZ) return OK.\n");
			}
			...
			else
			{
				...
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetStringReturn(DATA_RATE) return OK.\n");
			}
			...
			else
			{
				...
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetStringReturn(CHANNEL_BW) return OK.\n");
			}
			...
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(TX_POWER_DBM) return OK.\n");
			}

            err = ::vDUT_GetIntegerReturn(g_WiFi_Dut, "TX1",  &tagInputPara.TX1);
			if ( ERR_OK!=err )
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_GetIntegerReturn(TX1) return error.\n");
				throw logMessage;
			}
			else
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(TX1) return OK.\n");
			}

            err = ::vDUT_GetIntegerReturn(g_WiFi_Dut, "TX2",  &tagInputPara.TX2);
			if ( ERR_OK!=err )
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_GetIntegerReturn(TX2) return error.\n");
				throw logMessage;
			}
			else
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(TX2) return OK.\n");
			}

            err = ::vDUT_GetIntegerReturn(g_WiFi_Dut, "TX3",  &tagInputPara.TX3);
			if ( ERR_OK!=err )
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_GetIntegerReturn(TX3) return error.\n");
				throw logMessage;
			}
			else
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(TX3) return OK.\n");
			}

            err = ::vDUT_GetIntegerReturn(g_WiFi_Dut, "TX4",  &tagInputPara.TX4);
			if ( ERR_OK!=err )
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_GetIntegerReturn(TX4) return error.\n");
				throw logMessage;
			}
			else
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(TX4) return OK.\n");
			}
			...
			{
				/*
				ReturnErrorMessage(l_txCalReturn.ERROR_MESSAGE, "[WiFi] vDUT_GetStringReturn(PREAMBLE) return error.\n");
				return err;
				*/
			...
			else
			{
				...
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetStringReturn(PREAMBLE) return OK.\n");
			}
			...
			{
				/*
				ReturnErrorMessage(l_txCalReturn.ERROR_MESSAGE, "[WiFi] vDUT_GetStringReturn(PACKET_FORMAT_11N) return error.\n");
				return err;
				*/
			...
			else
			{
				...
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetStringReturn(PACKET_FORMAT_11N) return OK.\n");
			}
   ...
   //         err = ::vDUT_GetIntegerReturn(g_WiFi_Dut, "AVG_TIMES",  &tagInputPara.AVG_TIMES);
			//if ( ERR_OK!=err )
			//{
			//	LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi] vDUT_GetIntegerReturn(NUMBER_OF_AVG) return error.\n");
			//	throw logMessage;
			//}
			//else
			//{
			//	LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetIntegerReturn(NUMBER_OF_AVG) return OK.\n");
			//}
			...
			else
			{
				//UPPER CASE, IN CASE OF DUT GIVE LOWER CASE .
				_strupr_s(tagInputPara.DATA_RATE, MAX_BUFFER_SIZE);
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] vDUT_GetStringReturn(MEASURE_TYPE) return OK.\n");
			}
			...
			//else
			//{
			//	LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi] CheckPathLossTable() return OK.\n");
			//}
			...
			if(strcmp(tagInputPara.MEASURE_TYPE,"POWER")==0)
			{
				...
				if ( ERR_OK!=err )
				{
					...
					// IQlite merge; Tracy Yu ; 2012-03-31
					vDUT_Run(g_WiFi_Dut, "CALIBRATION_FAILED"); // to clear dut status. Does not need to do error check in case some other dut control does not need this function.
					throw logMessage;
				}
				else
				{
...
int TX_Cal_GetPowerAnalysisResult(tagAnalysisInputParameter tagInput, tagAnalysisOutput* tagOutput, double cableLossDb)
{
	...
	::TM_AddStringParameter (g_WiFi_Test_ID, "GUARD_INTERVAL_11N", tagInput.GUARD_INTERVAL_11N);  // IQlite merge; Tracy Yu ; 2012-03-31
