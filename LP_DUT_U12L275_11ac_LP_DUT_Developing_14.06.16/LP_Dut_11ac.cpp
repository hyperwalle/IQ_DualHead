...
int LP_initialize_dut(void)
{
	...
	try
	{
		...
		char CmdPrefix[16]="wl -i wl0 ";//2G and 5G command just Prefix different,use CmdPrefix mark command prefix before command use
		...
		// initialize 2.4g
		// run these commands once.
		char CmdPrefix2[16]="wl -i wl1 ";
		SendDutCmd(CmdPrefix2,"radio on");
...
int LP_tx_start(void)
{
	...
	try
	{
		...
		{
			SendDutCmd(CmdPrefix,"phy_forcecal 1");
			SendDutCmd(CmdPrefix,"pkteng_start 00:11:22:33:44:55 tx sync 50 100 250");
			SendDutCmd(CmdPrefix,"pkteng_stop tx");
			SendDutCmd(CmdPrefix,"pkteng_start 00:11:22:33:44:55 tx 100 1000 0");
		}
		else
		{
			SendDutCmd(CmdPrefix,"pkteng_start 00:11:22:33:44:55 tx sync 50 100 30");
			SendDutCmd(CmdPrefix,"pkteng_stop tx");
			SendDutCmd(CmdPrefix,"pkteng_start 00:11:22:33:44:55 tx 100 100 0");		
		}
