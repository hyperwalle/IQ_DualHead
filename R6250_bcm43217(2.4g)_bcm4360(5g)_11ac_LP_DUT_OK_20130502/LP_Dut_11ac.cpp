...
LP_DUT_11AC_API int WIFI_11AC_DutRegister(void)
{
	...
	g_rates.insert( pair<string, string>("MCS0",    "-m 0 -b %d") );
	g_rates.insert( pair<string, string>("MCS1",    "-m 1 -b %d") );
	g_rates.insert( pair<string, string>("MCS2",    "-m 2 -b %d") );
	g_rates.insert( pair<string, string>("MCS3",    "-m 3 -b %d") );
	g_rates.insert( pair<string, string>("MCS4",    "-m 4 -b %d") );
	g_rates.insert( pair<string, string>("MCS5",    "-m 5 -b %d") );
	g_rates.insert( pair<string, string>("MCS6",    "-m 6 -b %d") );
	g_rates.insert( pair<string, string>("MCS7",    "-m 7 -b %d") );
	g_rates.insert( pair<string, string>("MCS8",    "-m 8 -b %d") );
	g_rates.insert( pair<string, string>("MCS9",    "-m 9 -b %d") );
	g_rates.insert( pair<string, string>("MCS10",   "-m 10 -b %d") );
	g_rates.insert( pair<string, string>("MCS11",   "-m 11 -b %d") );
	g_rates.insert( pair<string, string>("MCS12",   "-m 12 -b %d") );
	g_rates.insert( pair<string, string>("MCS13",   "-m 13 -b %d") );
	g_rates.insert( pair<string, string>("MCS14",   "-m 14 -b %d") );
	g_rates.insert( pair<string, string>("MCS15",   "-m 15 -b %d") );
	g_rates.insert( pair<string, string>("MCS16",   "-m 16 -b %d") );
	g_rates.insert( pair<string, string>("MCS17",   "-m 17 -b %d") );
	g_rates.insert( pair<string, string>("MCS18",   "-m 18 -b %d") );
	g_rates.insert( pair<string, string>("MCS19",   "-m 19 -b %d") );
	g_rates.insert( pair<string, string>("MCS20",   "-m 20 -b %d") );
	g_rates.insert( pair<string, string>("MCS20",   "-m 21 -b %d") );
	g_rates.insert( pair<string, string>("MCS22",   "-m 22 -b %d") );
	g_rates.insert( pair<string, string>("MCS23",   "-m 23 -b %d") );
...
int LP_tx_set_bw(void)
{
	...
	try
	{
		...
		IsSameDut.nOldfreq = g_channel; // record the channel of last test item.
		// the commands below is for dualband concurrent with the same level chipset
		//g_nBandWidth = int(pow(dBase,g_CH_bandwidth+1)*10); // nBandWidth is global
		//if(g_channel<=14)
		//{
		//	SendDutCmd(CmdPrefix,"band b");
