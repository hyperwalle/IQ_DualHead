...
#pragma endregion
		...
		{	// Check vDut return "ERROR_MESSAGE" or not, if "Yes", must handle it.
			...
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi_11ac_MiMo] vDUT_Run(WRITE_MAC_REGISTER) return error.\n");
				throw logMessage;
			}
		}
		else
		{		
			...
			LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi_11ac_MiMo] vDUT_Run(WRITE_MAC_REGISTER) return OK.\n");
		}
	...
	{
		ReturnErrorMessage(l_writeMacRegisterReturn.ERROR_MESSAGE, "[WiFi_11ac_MiMo] Unknown Error!\n");
		err = -1;
	}
...
//	int    dummyInt = 0;
	...
	try
	{
		...
		sprintf_s(errorMsg, MAX_BUFFER_SIZE, "[WiFi_11ac_MiMo] CheckWriteMacRegisterParameters() Confirmed.\n");
	}
	catch(char *msg)
	{
