...
#pragma region Execute external program
        ...
        *--------------------------------*/
        ...
        {	
            ...
            {
                LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_ERROR, "[WiFi_11ac_MiMo] vDUT_Run(Run_Dut_Cmd) return error.\n");
                throw logMessage;
            }
        ...
        {
            LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi_11ac_MiMo] vDUT_Run(Run_Dut_Cmd) return OK.\n");
			...
			if ( ERR_OK==err )
			{
				LogReturnMessage(logMessage, MAX_BUFFER_SIZE, LOGGER_INFORMATION, "[WiFi_11ac_MiMo] vDUT_GetStringReturn(RESPONSE) return OK.\n");
			}
        }
#pragma endregion	   
...
#pragma endregion	
    ...
    {
		ReturnErrorMessage(l_runDutCmdReturn.ERROR_MESSAGE, "[WiFi_11ac_MiMo] Unknown Error!\n");
    }
