 ...
 */
#define IQMeasureVersion                "5 (2010-12-20)\n"
 ...
 */
IQMEASURE_API int LP_SetVsg(double rfFreqHz, double rfPowerLeveldBm, int port);
 ...
 * \return ERR_OK if no errors; otherwise call LP_GetErrorString() for detailed error message.
 */
IQMEASURE_API int LP_Agc(double *rfAmplDb);
 ...
 */
IQMEASURE_API int LP_VsaDataCapture(double samplingTimeSecs, int triggerType=6, double sampleFreqHz=80e6, int ht40Mode=OFF);
 ...
 * \return ERR_OK if no errors; otherwise call LP_GetErrorString() for detailed error message.
 */
IQMEASURE_API int LP_Analyze80211b(int eq_taps          = 5, 
...
/*
 ...
 1. LP_GPS_SetActivate
 2. //do what you want such as "Play Scenario File"
    LP_GPS_PlayScenarioFile
 3. LP_GPS_SetDeactivate
 */
IQMEASURE_API int LP_GPS_SetActivate();
IQMEASURE_API int LP_GPS_PlayScenarioFile(char* fileName, double power, double pathloss, IQV_GPS_TRIGGER_STATE triggerState);
IQMEASURE_API int LP_GPS_ModulatedMode(int Nav_Mode, double pathloss, double powerA[6], int satelliteNumA[6], int dopplerFrequency, IQV_GPS_TRIGGER_STATE triggerState);
IQMEASURE_API int LP_GPS_SetDeactivate();
//IQMEASURE_API int LP_GPS_SetDefault(int dopplerFrequency, IQV_GPS_TRIGGER_STATE triggerState);
