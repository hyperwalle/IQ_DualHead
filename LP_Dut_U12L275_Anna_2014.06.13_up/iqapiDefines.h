...
{
    IQV_CONNECTION_IQ201X,
    IQV_CONNECTION_IQFM,
    IQV_CONNECTION_IQNAV,
    IQV_CONNECTION_OTHER
};
...
typedef unsigned    long int    uint32;   //!<  Indicates that the range is between Uint32:0 ... 4294967295
...
typedef signed      long int    int32;    //!<  Indicates that the range is between Int32: -2147483650 ...
